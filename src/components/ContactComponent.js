...
import { Breadcrumb, BreadcrumbItem, Form, FormGroup, Label, Button, Input, Col, FormFeedback } from 'reactstrap';
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    ...
                                    onBlur={this.handleBlur('firstname')} valid={errors.firstname === '' && this.state.touched.firstname==true}
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type='text' id='lastname' name='lastname' placeholder="Last Name"
                                        ...
                                        onBlur={this.handleBlur('lastname')} valid={errors.lastname === '' && this.state.touched.lastname==true}
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type='tel' id='telnum' name='telnum' placeholder="Telephone Number"
                                        ...
                                        onBlur={this.handleBlur('telnum')} valid={errors.telnum === '' && this.state.touched.telnum==true}
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type='email' id='email' name='email' placeholder="example@email.com"
                                        ...
                                        onBlur={this.handleBlur('email')} valid={errors.email === '' && this.state.touched.email==true}
